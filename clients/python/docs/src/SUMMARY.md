...
- [Composing a piece, step by step](composing.md)
  ...
  - [Materials: the five primitives](composing/materials.md)
  - [Grouping: placing materials in time](composing/grouping.md)
  - [Realization: hearing the model](composing/realization.md)
  - [The multitrack editor: the model on screen](composing/editor.md)
  - [Editing on screen: the loop closed](composing/editing.md)
  - [Automation: a curve as material](composing/automation.md)
