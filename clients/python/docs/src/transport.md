...
- **No global play/stop or song position.** The server does not roll a playhead. "Pressing play" is starting *your* clock with a `quant` onto the shared bar; stopping is stopping your clock. Each client owns its own transport-rolling.
