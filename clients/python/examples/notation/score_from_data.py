...
from clausters import Event, Session, TempoMap
...
# timeline's time are the same axis, which is what ties the cursor to the sound -- a quarter is one beat in the model and half a second on the page.
TEMPO = 2.0
