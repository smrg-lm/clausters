...
Pass a track count::
    ...
    python clients/python/examples/views/recording.py 16
...
here and watch the host's CPU with ``top`` while it records::
    ...
    python clients/python/examples/views/recording.py 16 0     # every frame
    python clients/python/examples/views/recording.py 16 1     # one-second blocks
...
<path>``. With the client importable (``pip install -e ./clients/python``)::
    ...
    python clients/python/examples/views/recording.py
