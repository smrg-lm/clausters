...
class AbstractObject:
    ...
    def asinteger(self): return self._compose_unop("asint")
    def asfloat(self): return self._compose_unop("asfloat")
    ...
    def hypotapx(self, other): return self._compose_binop("hypotapx", other)
