...
### Compositional model + multitrack editor (client arc, phased)

The recursive-granularity composition/editor track: a client-side compositional
model realized onto the server (RT/NRT), a GUI multitrack widget, and the bridge
between them. Each phase ships incrementally.
