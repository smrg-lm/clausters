...
A single memory region (ABI v11; 860 864 bytes with the default 16 384 control buses, 1 024 audio buses, 8 audio taps of 16 384 samples and a 4 096-row buffer directory) holding, in order:
