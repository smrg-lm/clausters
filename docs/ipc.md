...
A single memory region (ABI v10; 853 696 bytes with the default 16 384 control buses, 128 audio buses, 8 audio taps of 16 384 samples and a 4 096-row buffer directory) holding, in order:
