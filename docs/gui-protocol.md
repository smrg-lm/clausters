...
points. Nothing layers today — the `clip` widget was the first and so far only
one, and it is gone now that a multitrack holds its boxes as props — and the
rule is kept because it is what an entered box comes back through.
