...
```text
/transport_query  i <t>                           →  /transport_query.reply  h <originSample>  d <tempo>  i <defined>  i <playing>  d <position>  i <group>  h <transportSample>  h <positionSample>  h <loopStart>  h <loopEnd>  h <endSample>  h <returnSample>  i <t>  i <followGroup>
