...
//! - **Bark** (Traunmuller): `z = 26.81 * f / (1960 + f) - 0.53`, chosen over
...
/// Hertz -> bark (Traunmuller). Negative input is treated as 0; the value at
...
mod tests {
    ...
    #[test]
    fn bark_landmarks() {
        // 1 kHz is ~8.5 bark (Traunmuller); 0 Hz sits at the -0.53 floor.
